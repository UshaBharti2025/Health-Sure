...
<body>
    ...
    <div class="navbar">
        ...
        <h:form><h:commandLink value="Search" action="SearchRecipientbase" /></h:form>
        <h:form><h:commandLink value="Show" action="ShowRecipientbase" /></h:form>
        <h:form><h:commandLink value="Update" action="UpdateRecipientbase" styleClass="active" /></h:form>
    </div>
    ...
    <div class="form-container">
        <h:form prependId="false">
            ...
            <div class="link-group">
                <h:commandLink value="Back to Search Page" action="SearchRecipientbase" />
                <h:commandLink value="Go to Recipient Dashboard" action="dashboardbase" />
            </div>
        </h:form>
    </div>
