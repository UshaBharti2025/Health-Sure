...
//        this.searchHid = null;
//        this.searchCreatedAt = null;
//        this.recipientList = new ArrayList<Recipient>();
//        FacesContext.getCurrentInstance().getViewRoot().getChildren().clear();
//        return "searchRecipient1";  // stay on same page
//    }
    public String resetSearch() {
        System.out.println("reset called");

        searchValue = null; // ✅ THIS IS THE FIELD USED IN YOUR JSP
        searchType = null;
        nameSearchMode = null;
        recipientList = new ArrayList<>(); // assuming you're showing results from this

        return null; // or "searchRecipient1" if navigation is used
    }

    
//    /** Resets all search-related state and redirects to search page */
//    public String resetSearch() {
//        // Clear search inputs
//        this.searchHid = null;
//        this.searchFirstName = null;
...
//        this.nameSearchMode = "contains"; // optionally reset to default
//
//        // Clear results and sorting/pagination
//        this.recipient = null;
//        this.recipientList = null;
//        this.sortColumn = "";
//        this.sortAscending = true;
//        this.currentPage = 0;
//
//        // Redirect to search page (replace with actual view name)
...
//        if (searchType == null || searchValue == null || searchValue.trim().isEmpty()) {
//            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
//                    "Please select a search type and enter a value.", null));
//            recipient = null;
//            recipientList = new ArrayList<>();
//            return null;
//        }
...
//        switch (searchType) {
//            case "hid":
//                if (!searchValue.matches("^HID\\d{3}$")) {
//                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
...
//
//            case "firstName":
//                if (!searchValue.matches("^[A-Za-z]{2,}$")) {
//                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
//                            "First name must be at least 2 alphabetic characters.", null));
//                    recipientList = null;
//                    return null;
//                }
//                searchFirstName = searchValue;
...
//
//            case "mobile":
//                if (!searchValue.matches("^[1-9]\\d{9}$")) {
//                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
//                            "Mobile number must be 10 digits and not start with 0.", null));
//                    recipientList = null;
//                    return null;
//                }
//                searchMobile = searchValue;
...
//
//            case "createdAt":
//                // Basic pattern check: yyyy-MM-dd
//                if (!searchValue.matches("^\\d{4}-\\d{2}-\\d{2}$")) {
//                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
//                            "Date must be in format YYYY-MM-DD.", null));
//                    recipientList = null;
//                    return null;
//                }
//                searchCreatedAt = searchValue;
...
//            default:
//                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
//                        "Invalid search type selected.", null));
//                recipient = null;
//                recipientList = new ArrayList<>();
//        }
//
//        return "SearchRecipient1"; // or null if staying on the same page
//    }
