...
//
//            if (fresh != null) {
//                recipient = fresh;  // To Replace the reference
//            }
//
//            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("recipient", recipient);
//
//            FacesContext.getCurrentInstance().addMessage(null,
//                new FacesMessage(FacesMessage.SEVERITY_INFO, "Changes discarded", ""));
//        }
...
//        FacesContext.getCurrentInstance().addMessage(null,
//            new FacesMessage("Recipient updated successfully"));
//        return null;
//    }

    // Discard/Reset method 
    
//    2
//    public String resetUpdate() {
//        try {
//            if (recipient != null && recipient.gethId() != null) {
//                // Force a fresh database read
//                Recipient freshCopy = recipientDao.getRecipientByhId(recipient.gethId());
//                
//                // Manually copy all properties
//                this.recipient.setFirstName(freshCopy.getFirstName());
//                this.recipient.setLastName(freshCopy.getLastName());
//                this.recipient.setMobile(freshCopy.getMobile());
//                this.recipient.setEmail(freshCopy.getEmail());
//                // Copy all other fields...
//                
//                FacesContext.getCurrentInstance().addMessage(null,
//                    new FacesMessage("Changes discarded successfully"));
//            }
//        } catch (Exception e) {
//            FacesContext.getCurrentInstance().addMessage(null,
//                new FacesMessage(FacesMessage.SEVERITY_ERROR, 
//                "Error discarding changes", null));
//        }
//        
//        // Force full page refresh by redirecting to same view
...
//                // Add all additional fields if any...
//
...
//        }
//
//        // Redirect to same page (refresh and remove form data)
//        return "UpdateRecipient1?faces-redirect=true&hid=" + recipient.gethId();
//    }
...
//    public String resetUpdate() {
//        System.out.println("Discarding changes for hId: " + recipient.gethId());
//
//        if (recipient != null && recipient.gethId() != null) {
//            Recipient freshCopy = recipientDao.getRecipientByhId(recipient.gethId());
//            this.recipient = freshCopy;
//        }
//
//        FacesContext.getCurrentInstance().addMessage(null,
//            new FacesMessage("Changes discarded"));
//        return null;
//    }
//
//
    ...
    public String goToSearch() {
    	return "SearchRecipient1?faces-redirect=true";
//        return "SearchRecipient1"; // must match navigation case
    }

    public String goToDashboard() {
    	return "dashboard1?faces-redirect=true";

//        return "dashboard1"; // must match navigation case
    }
    
//    public String fetchRecipient() {
//        // Your logic to fetch recipient by hId
//        recipient = service.getRecipientById(recipient.gethId());
//        
//        if(recipient != null) {
//            FacesContext.getCurrentInstance().addMessage(null, 
//                new FacesMessage("Recipient data loaded successfully"));
//            // Execute JavaScript to enable fields
//            RequestContext.getCurrentInstance().execute("enableFormFields()");
//        } else {
//            FacesContext.getCurrentInstance().addMessage(null, 
//                new FacesMessage(FacesMessage.SEVERITY_ERROR, 
//                "Recipient not found", null));
//        }
//        
